...
void AlignColorSpaceGappedConstrained(char*, char*, int, char*, int, ScoringMatrix*, AlignedEntry*, AlignMatrix*, int32_t, int32_t, int32_t, char);
void AlignColorSpaceRecoverAlignmentFromMatrix(AlignedEntry*, AlignMatrix*, char*, int, char*, int, int, int32_t, char, int, int);

void AlignColorSpaceInitializeAtStart(char*, AlignMatrix*, ScoringMatrix*, int32_t, int32_t, int32_t);
