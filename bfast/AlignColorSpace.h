...
void AlignColorSpaceUngapped(char*, char*, int, char*, int, int, ScoringMatrix*, AlignedEntry*, int, uint32_t, char);
...
void FillAlignedEntryFromMatrixColorSpace(AlignedEntry*, AlignMatrixCS**, char*, int, char*, int, int, uint32_t, char, int, int);
