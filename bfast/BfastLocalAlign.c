...
static struct argp_option options[] = {
	...
	{"matchFileName1", 'O', "matchFileName1", 0, "Specifies the bfast matches file for read 1 (-1 also works)", 1},
	{"matchFileName2", 'T', "matchFileName2", 0, "Specifies the bfast matches file for read 2 (-2 also works)", 1},
