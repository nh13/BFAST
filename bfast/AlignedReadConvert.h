...
void AlignedReadConvertPrintOutputFormat(AlignedRead*, RGBinary*, FILE*, gzFile, char*, int, int, int);
...
void AlignedReadConvertPrintSAM(AlignedRead*, int32_t, char*, FILE*);
void AlignedReadConvertPrintAlignedEntryToSAM(AlignedRead*, int32_t, int32_t, int32_t, char*, FILE*);
