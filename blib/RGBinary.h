...
int32_t RGBinaryGetSequence(RGBinary*, int32_t, int32_t, int8_t, char**, int32_t);
void RGBinaryGetReference(RGBinary*, int32_t, int32_t, int8_t, int32_t, char**, int32_t, int32_t*, int32_t*);
