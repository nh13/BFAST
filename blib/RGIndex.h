...
int RGIndexCompareAt(RGIndex*, RGBinary*, unsigned long long int, unsigned long long int);
int RGIndexCompareRead(RGIndex*, RGBinary*, char*, unsigned long long int);
#endif
